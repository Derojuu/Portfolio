  ...
  return (
    <div className="space-y-16 animate-fade-in">
        ...
        <div className="relative z-10 animate-slide-up">
          <h2 className="text-5xl md:text-6xl font-bold mb-4">
            <span className="gradient-text-animated inline-flex items-center gap-3">
              <Trophy className="h-12 w-12 animate-bounce-slow" />
              Professional Journey
            </span>
          </h2>
          <p className="text-xl md:text-2xl text-muted-foreground">Building impactful solutions across diverse industries</p>
        ...
        {experiences.map((experience, index) => {
          ...
          return (
            <div key={index} className="relative animate-stagger-${index + 1}">
              {/* Timeline Line */}
              <div className="absolute left-6 top-16 w-0.5 h-full bg-gradient-to-b from-blue-600 to-purple-600 opacity-20"></div>
              
              {/* Timeline Node */}
              <div className="absolute left-4 top-8 w-5 h-5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full border-4 border-white dark:border-gray-900 animate-pulse"></div>
              
              <Card className={`ml-16 group hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 overflow-hidden ${
                experience.highlight === 'Current Role' ? 'ring-2 ring-blue-500/30 bg-gradient-to-br from-blue-50/50 via-white to-green-50/50 dark:from-blue-900/20 dark:via-gray-800 dark:to-green-900/20' : 
                  ...
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                    <div className="space-y-2 flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <CardDescription className="text-lg font-semibold gradient-text">
                            {experience.company}
                          </CardDescription>
                        </div>
                      </div>
                      ...
                      <Badge 
                        ...
                        className={`w-fit ${experience.highlight === 'Current Role' ? 'bg-green-600 animate-pulse' : 'bg-purple-600'}`}
                      >
                    ...
                    <div className="space-y-2 text-right">
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <Badge variant="outline" className="ml-2 text-xs">{experience.type}</Badge>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border">
                    ...
                    <div className="text-sm">{experience.metrics}</div>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {experience.achievements.map((achievement, achievementIndex) => (
                        <li key={achievementIndex} className="flex items-start gap-3 text-sm text-muted-foreground group/item">
                          <div className="w-2 h-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full mt-2 group-hover/item:animate-pulse"></div>
      ...
      <div className="text-center py-8 animate-slide-up-delayed">
        <Card className="max-w-2xl mx-auto bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 border-2 hover-lift">
          <CardContent className="pt-8">
            ...
            <div className="flex items-center justify-center gap-4">
              <Badge className="bg-green-600">Available for Projects</Badge>
